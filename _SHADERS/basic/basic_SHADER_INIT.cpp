    ...
    "     lightPosition_PASS_01   =  normalize(lightMatrix * light_POSITION_01 - position);                                   \n" 
          //-------------------------------------------------------------------------------
    "     gl_Position             =  projection * view  * modelWorld * position;                    \n" 
    ...
    "    NdotL1                   =  max(dot(normal_PASS, normalize(lightPosition_PASS_01.xyz)), 0.0);  \n" 
        //----------------------------------------------------------------------------                                                   
    ...
    "    shadowVal                =  comp <= depth_PowerVR ? 1.0 : 0.3;                                                             \n" 
         ...
         " highp float invert_NdotL1 =    -1.0 * (1.0 - NdotL1);                                \n"
 
 
//    "    gl_FragColor             =  texture2D(Texture1,  varTexcoord.xy) * 0.4    \n" 
//    "                             +  texture2D(Texture1,  varTexcoord.xy) * NdotL1 * NdotL1 *0.6    \n" 
//    "                             + (texture2D(Texture1,  varTexcoord.xy) * invert_NdotL1* invert_NdotL1*0.2 )                 \n" 
//    "                             +  highp vec4(max(pow(NdotL1*NdotL1*NdotL1*NdotL1*NdotL1, 500.0), 0.0)) *  texture2D(Texture1,  varTexcoord.xy);                                         \n" 
    ...
    "          gl_FragColor             = highp vec4(1.0);                                  \n"       
    
    "    }                                                                                  \n"   
 
    "    else if(NdotL1 > 0.2)                                                              \n"   
    "    {                                                                                  \n"      
    "          gl_FragColor             = highp vec4(0.43*.8, 0.4*.8, 0.31*.8, 1.0);                 \n"   
    "    }                                                                                  \n"   
  
    "    else                                                                               \n"   
    "    {                                                                                  \n"   
    "          gl_FragColor            =  highp vec4(0.43*.5, 0.4*.5, 0.31*.5, 1.0);                 \n"   
    "    }                                                                                  \n"   
